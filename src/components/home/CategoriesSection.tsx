  ...
  return (
    <section className="container mx-auto py-20">
      <div className="flex items-end justify-between mb-10 flex-wrap gap-4">
        <div>
          <h2 className="text-3xl md:text-5xl font-black tracking-tight">Popular categories</h2>
          <p className="mt-2 text-muted-foreground">Browse the most loved services on Needlyy.</p>
        </div>
        <a href="#" className="text-sm font-bold text-primary hover:underline inline-flex items-center gap-2">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
        {MOCK_CATEGORIES.map((cat, i) => {
          ...
          return (
            <a key={cat.id} href="#" className="group relative bg-card border border-border rounded-3xl p-5 hover:shadow-glass hover:-translate-y-1 transition-all overflow-hidden">
