  ...
  return (
    <section className="container mx-auto py-20">
      <div className="flex items-end justify-between mb-10 flex-wrap gap-4">
        <div>
          <h2 className="text-3xl md:text-5xl font-black tracking-tight">Recently added</h2>
          <p className="mt-2 text-muted-foreground">Fresh listings from sellers across Sri Lanka.</p>
        </div>
